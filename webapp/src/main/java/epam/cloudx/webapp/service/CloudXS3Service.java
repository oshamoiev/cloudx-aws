...
@Service
public class CloudXS3Service {

    private static final String S3_BUCKET_NAME = "oleksandr-shamoiev-bucket";

    private final AmazonS3 amazonS3;

    private final CloudXFileService cloudXFileService;

    public CloudXS3Service(AmazonS3 amazonS3, CloudXFileService cloudXFileService) {
    ...
    public byte[] downloadObject(String objectName) {
        ...
        return cloudXFileService.readBitmap(o);
    }
